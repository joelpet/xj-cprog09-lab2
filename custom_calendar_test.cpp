...
int main() {
    ...
    cal.set_date(2010, 12, 2);
    cal.add_event("Basketträning", 4, 12, 2010);
    cal.add_event("Basketträning", 11, 12, 2010);
    cal.add_event("Nyårsfrukost", 1, 1, 2011);
    ...
    cal.add_event("Min första cykel", 20, 12, 2010);
